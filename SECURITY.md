...
This policy covers the `gianfriaur/opcua-php-client-session-manager` library itself. For vulnerabilities in dependencies or related packages, please report them to the respective maintainers:
